...
class State():
    ...
    def interp_K_bar(self):
        if self.T == 'T_sat':
           self. T = interp_T_sat(self.df,self.P,'T saturated vapour K')
    ...
    def __str__(self):
        return 'The thermodinamic property {} has a value of {}'.format(self.param, self.interp_K_bar()[0])
